        ...
        <div className="card-header flex justify-between items-center mb-6 pb-2 border-b-2 border-gray-100">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              disabled={loading}
              className="inline-flex items-center px-4 py-2 bg-gray-100 text-gray-700 border border-gray-300 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-gray-200 hover:border-gray-400 hover:text-gray-900 hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div className="flex flex-col items-center justify-center h-64 text-gray-500">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  No report data found. Please try refreshing or adjusting your filters.
                </p>
              </div>
            </div>
          )}
